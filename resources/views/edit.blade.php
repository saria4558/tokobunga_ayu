              ...
              <div class="card-body">
                <form action = "/updatedata/{{$data->id}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="nama_bunga" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->nama_bunga}}" >

                  </div>
                  <div class="mb-3">
                    <label for="formFileMultiple" class="form-label">Referensi Bucket Bunga</label>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->price}} ">
